...
JAZZMIN_SETTINGS = { 
    "site_title": "Portfolio",  # Заголовок сайта
    "site_header": "Portfolio",  # Заголовок на экране входа
    "site_brand": "Администрация Сайта",  # Выходит на сайте вместо Django-admin.(Администрирование сайта)
    "welcome_sign": "Welcome to the Hich Shcool Portfolio",  # Приветственный текст на экране входа
    "copyright": "Portfolio",  # Авторское право (footer)
